...
def create_metadata_and_accession():
    ...
    sraRunTable_df.Run.to_csv(DIR+"/time2splice/data/SraAccList.csv", index=False)
    sraRunTable_df.to_csv(DIR+"/time2splice/data/metadata.csv", index=False)
    print("Saved metadata file and SRA accession list here:",DIR+"/time2splice/data/SraAccList.csv")
